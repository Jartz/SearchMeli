...
extension HomeVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "adsCell", for: indexPath) as? AdsCell else { return UITableViewCell() }
            cell.carrousel(pagerView)
            return cell
        case 1:
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "initialAccount", for: indexPath) as? InitialCell else { return UITableViewCell() }
            cell.vc = self
            return cell
        default:
